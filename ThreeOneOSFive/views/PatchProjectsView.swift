...
struct PatchProjectsView: View {
        ...
        NavigationStack {
            ZStack {
                ...
                VStack(spacing: 0) {
                    ...
                    // Thanh Tabs Thư Mục (Aim, Guns, Chams, Outfits và các thư mục từ web)
                            ...
                            ForEach(dynamicTabs, id: \.self) { tab in
                                Button(action: { UXFeedback.click(); selectedTab = tab }) {
                                    Text(tab)
                                        ...
                                        .padding(.horizontal, 20)
                                        .padding(.vertical, 10)
                                        .background(selectedTab.lowercased() == tab.lowercased() ? Color.white : Color.black.opacity(0.6))
                    ...
                    // Danh Sách Chức Năng Của Thư Mục
                ...
                VStack {
                    Spacer()
                    Button(action: { UXFeedback.click() }) {
                        HStack {
    ...
    private var gameTitleName: String {
        ...
        case "com.dts.freefireth": return "Free Fire Thường"
        default: return "Free Fire"
        }
    }
...
// Hàng Chức Năng Kèm Nút Gạt Bật/Tắt (Áp Dụng / Khôi Phục)
